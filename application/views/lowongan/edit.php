              ...
              <?php $this->load->view('include/navbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <nav style="--bs-breadcrumb-divider: '▸';" aria-label="breadcrumb">
					    <ol class="breadcrumb">
					        <li class="breadcrumb-item">
					            <a href="<?php echo base_url('/index.php/lowongan/index') ?>">Data Lowongan</a>
					        </li>
                    ...
                    <?php echo form_open_multipart('lowongan/update'); ?>
                        ...
                        <input type="hidden" name="id" class="form-control" value="<?= $lowongan->id?>">
                    
                            <div class="form-group">
                                <label for="exampleInputtext1">Nama Perusahaan/Organisasi</label>
                                <input type="text" class="form-control" value="<?= $lowongan->nama_perusahaan?>"  maxlength="30" name="nama_perusahaan">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_pekerjaan"  class="form-control" value="<?= $lowongan->deskripsi_pekerjaan?>" ></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tanggal_akhir"  value="<?= $lowongan->tanggal_akhir?>">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputtext1">MitraID</label>
                                <input type="text" class="form-control"  maxlength="30" name="mitra_id" value="<?= $lowongan->mitra_id?>">
                            </div>
