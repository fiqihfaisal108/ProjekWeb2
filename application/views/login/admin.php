            ...
            <div class="row d-flex">
                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <form class="user" method="POST" action="<?=base_url()?>index.php/admin/aksi_login">
                        ...
                        <small class="font-weight-bold"> Masuk Sebagai <a class="text-danger" href="<?php echo base_url()?>index.php/login/login">User</a></small> </div>
                    </div>
                </div>
            </div>
            <div class="bg-gradient-dark text-light py-4">
