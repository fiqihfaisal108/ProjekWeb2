                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        <div class="row mb-4 px-3">
                            <h6 class="mb-0 mr-4 mt-2">Register Dengan</h6>
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Daftarkan Username Anda" name="username">
                        </div>
                        
                        <div class="form-group">
                            <input type="password" class="form-control form-control-user"
                            id="exampleInputPassword" placeholder="Daftarkan Password Anda" name="password">
                        </div>
                        ...
                        <div class="row mb-4 px-3"> <small class="font-weight-bold">Punya Akun ? <a class="text-primary" href="<?=base_url()?>index.php/login/aksi_login">Log in</a></small> </div>
                    </div>
                </div>
            </div>
