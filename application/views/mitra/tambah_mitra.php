        ...
        <div id="content">
          ...
          <?php $this->load->view('include/navbar');?>
            ...
            <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <nav style="--bs-breadcrumb-divider: '▸';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item"><a href="<?php echo base_url('/index.php/mitra/index') ?>">Data Mitra</a></li>
                ...
                <?php echo form_open_multipart('mitra/tambah'); ?>

                <div class="form-group row mb-3 mt-2">
												<label for="inputEmail3" class="col-sm-2 col-form-label">Nama Perusahaan :</label>
												<div class="col-sm-10">
												  <input type="text" class="form-control" id="inputEmail3"  placeholder="Masukan Nama Perusahaan" name="nama_mitra" >
												</div>
											  </div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="inlineCheckbox2">Startup</label>
											  ...
											  <div class="form-group row mb-3">
												...
												<div class="col-sm-10">
													<textarea name="alamat" cols="163px" rows="5" class="form-control"  id="exampleInputEmail1" placeholder="Masukan Alamat Kantor"></textarea>
												</div>
											  </div>
											  <div class="form-group row mb-3">
												<label for="inputEmail3" class="col-sm-2 col-form-label">Kontak Person :</label>
												<div class="col-sm-10">
												  <input type="text" class="form-control" id="inputEmail3"  placeholder="Masukan Kontak Person" name="kontak">
												</div>
											  </div>
											...
											<div class="form-group row mb-3">
											  ...
											  <div class="col-sm-10">
												<input type="email" class="form-control" id="inputEmail3"  placeholder="user@gmail.com" name="email">
											  </div>
											</div>
											<div class="form-group row mb-3">
												<label for="inputEmail3" class="col-sm-2 col-form-label">Alamat Web :</label>
												<div class="col-sm-10">
												  <input name="web" type="text" class="form-control" id="inputEmail3"  placeholder="http://">
												</div>
											  </div>
