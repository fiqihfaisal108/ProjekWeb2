...
<body style="font-family: poppins; color: #1B1B1B;">
    ...
    <br>
	  ...
	  <div class="container">
		  <div class="row">
			  <div class="card border border-3 border-warning mb-3">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="home.html" style="color:#052473;">Home </a>
              </li>
              <i class="fa fa-angle-right" aria-hidden="true" style="padding-top: 12px;"></i>
              <li class="nav-item">
                <a class="nav-link" href="BeritaJaya.html" style="color:#052473;">Daftar Mitra</a>
            </li>
            <i class="fa fa-angle-right" aria-hidden="true" style="padding-top: 12px;"></i>
              <li class="nav-item">
                  <a class="nav-link disabled" style="color: grey">Form Menjadi Mitra</a>
              </li>
          </ul>
							</div>
						</div>
				  ...
				  <div class="container">
					<div class="row">
							...
							<div class="card-body">
								<div class="row">
									<div class="col">
										<h4 class="text" style="color: #ed840e;">Form Menjadi Mitra</h4>
										
										<?php echo form_open_multipart('mitra/tambah_user'); ?>

                <div class="form-group row mb-3 mt-5">
												<label for="inputEmail3" class="col-sm-2 col-form-label">Nama Perusahaan :</label>
												<div class="col-sm-10">
												  <input type="text" class="form-control" id="inputEmail3" style="border-color: #052473;" placeholder="Masukan Nama Perusahaan" name="nama_mitra" >
												</div>
											  </div>
											  <div class="form-group row mb-3">
												  <label for="" class="col-sm-2 col-form-label">Bidang Usaha :</label>
												  <div class="col-sm-10">
													<select class="form-control"  style="color: #052473; border-color: #052473;" name="bidang_usaha_id">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="sektor_usaha_id" value="1">
                                                <label class="form-check-label" for="inlineCheckbox1">Pemerintah</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="sektor_usaha_id" value="2">
                                        <label class="form-check-label" for="inlineCheckbox2">BUMN</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="sektor_usaha_id" value="3">
                                        <label class="form-check-label" for="inlineCheckbox1">Swasta</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="sektor_usaha_id" value="4">
                                        <label class="form-check-label" for="inlineCheckbox2">Startup</label>
											  ...
											  <div class="form-group row mb-3">
												...
												<div class="col-sm-10">
													<textarea name="alamat" cols="163px" rows="5" class="form-control" style="border-color: #052473;" id="exampleInputEmail1" placeholder="Masukan Alamat Kantor"></textarea>
												</div>
											  </div>
											  <div class="form-group row mb-3">
												<label for="inputEmail3" class="col-sm-2 col-form-label">Kontak Person :</label>
												<div class="col-sm-10">
												  <input type="text" class="form-control" id="inputEmail3" style="border-color: #052473;" placeholder="Masukan Kontak Person" name="kontak">
												</div>
											  </div>
											...
											<div class="form-group row mb-3">
											  ...
											  <div class="col-sm-10">
												<input type="email" class="form-control" id="inputEmail3" style="border-color: #052473;" placeholder="user@gmail.com" name="email">
											  </div>
											</div>
											<div class="form-group row mb-3">
												<label for="inputEmail3" class="col-sm-2 col-form-label">Alamat Web :</label>
												<div class="col-sm-10">
												  <input name="web" type="text" class="form-control" id="inputEmail3" style="border-color: #052473;" placeholder="http://">
												</div>
											  </div>
											<div class="form-group row">
											  <div class="col text-right">
												<button type="submit" class="btn" id="kirim" style="color: white; background-color: #052473;">
													<i class="fa fa-paper-plane"></i>
													 Daftar
												</button>
												<button type="reset" class="btn border-2" id="hapus" style="color: #052473; border-color: #052473;">
