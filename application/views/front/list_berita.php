...
<!--konten-->
	<div class="row">
		<div class="col-md-12">
			<h3 class="text-center" style="color: #052473;">
				Berita
            </h3>
        <br></br>
    </div>
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-2">
                    <img src="<?php echo base_url()?>/img/berita01.png" class="rounded mx-auto d-block" alt="...">
                </div>
                <div class="col-md-9 mt" style="color: #052473;">
                    <p href="" class="h3"> Jurusan Unggulan di Era Revolusi Industri 4.0 dan Prospek Kerjanya</p>
                    <button type="button" class="btn btn-warning btn-sm-2 mt-3"><a href="<?php echo base_url()?>index.php/welcome/detail"> Detail</a></button>
                </div>
                
            </div>
            <br><hr style="color: #8b4a00;"></br>
            <div class="row">
                <div class="col-md-2">
                    <img src="<?php echo base_url()?>/img/berita02.png" class="rounded mx-auto d-block" alt="...">
                </div>
                <div class="col-md-9 mt" style="color: #052473;">
                    <p href="" class="h3"> Tips Bikin UI/UX Ramah Pengguna dari Engineer Tokopedia </p>
                    <button type="button" class="btn btn-warning btn-sm-2 mt-3"><a href="<?php echo base_url()?>index.php/welcome/detail2"> Detail</a></button>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <img src="<?php echo base_url()?>/img/berita03.png" class="rounded mx-auto d-block" alt="...">
                </div>
                <div class="col-md-9 mt" style="color: #052473;">
                    <p href="" class="h3">Kemitraan untuk Menghubungkan GenZ dan Milenial yang Ramah pada Teknologi</p>
                    <button type="button" class="btn btn-warning btn-sm-2 mt-3"><a href="<?php echo base_url()?>index.php/welcome/detail3"> Detail</a></button>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <img src="<?php echo base_url()?>/img/berita04.png" class="rounded mx-auto d-block" alt="ini gambar">
                </div>
                <div class="col-md-9 mt" style="color: #052473;">
                    <p href="" class="h3">Generasi Millenial Pengaruhi Nasib Ekonomi Indonesia</p>
                    <button type="button" class="btn btn-warning btn-sm-2 mt-3"><a href="<?php echo base_url()?>index.php/welcome/detail4"> Detail</a></button>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <img src="<?php echo base_url()?>/img/berita05.png" class="rounded mx-auto d-block" alt="ini gambar">
                </div>
                <div class="col-md-9 mt" style="color: #052473;">
                    <p href="" class="h3">5 UX Tips To Build A High Converting Landing Page</p>
                    <button type="button" class="btn btn-warning btn-sm-2 mt-3"><a href="<?php echo base_url()?>index.php/welcome/detail5"> Detail</a></button>
                </div>
