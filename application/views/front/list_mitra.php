         ...
         <div class="card-body text-warning">
                        <div class="row">
                            <div class="col-md-9" style="color: #002147;">
                                <h5>
                                  <a class="nav-link font-weight-bold h4" href="<?php echo base_url()?>index.php/welcome/form_mitra" style="color:#052473;">Daftar Menjadi Mitra</a>
                                </h5>
                            </div>
                            <div class="col-md-3">
                              <ul class="nav mr-sm-3" style="font-size: 14px;">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link disabled" style="color: grey">Daftar Mitra</a>
                                </li>
                            </ul>
                            </div>
                        </div>
...
<!--konten-->
	<div class="row">
		<div class="col-md-12">
			<h3 class="text-center" style="color: #002147;">
				Mitra Perusahaan Kami
      </h3>
    </div>
        <div class="col-md-12">
          <div class="col-md-6 mt-3">
            <img alt="ini gambar" src="<?php echo base_url()?>/img/sttnf.png" style="width: 400px; padding-right: 240px; padding-bottom: 31px; padding-top: 23px;">
        </div>
            <h3 style="color: #f38605;">
                PT. Nurul Fikri
            </h3>
            <p style="color: #002147;">
                PT. Nurul Fikri merupakan salah satu PT yang bergerak di bidang Teknologi dan Informasi.
            </p>
            <hr style="color: #8b4a00;">
        </div>


        <div class="col-md-6 mt-3">
          <img alt="ini gambar" src="<?php echo base_url()?>/img/biznet.png" style="width: 450px; padding-right: 240px; padding-bottom: 31px; padding-top: 23px;">
      </div>
      <div>
			<h3 style="color: #f38605;">
				PT. Bonet
      ...
      <div class="col-md-6 mt-3">
        <img alt="ini gambar" src="<?php echo base_url()?>/img/indofood.jpg" style="width: 450px; padding-right: 240px; padding-bottom: 31px; padding-top: 23px;">
    </div>
			<h3 style="color: #f38605;">
				PT. Indofood
			</h3>
			<p style="color: #002147;">
				PT. Indofood Sukses Makmur Tbk (INDF) bergerak dalam bidang makanan olahan, bumbu, minuman, kemasan, minyak goreng, pabrik gandum dan pabrik pembuatan karung tepung.&lt;br&gt;Perusahaan mulai beroperasi secara komersial pada tahun 1990.
			</p>
