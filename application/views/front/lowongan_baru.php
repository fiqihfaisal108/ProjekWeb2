...
<!--breadcrumb-->
	<div class="container">
		<div class="row">
			<div class="col-9">
				<div class="card border-warning mt-4" style="width: 100;">
        					...
        					<div class="col-md-12">
        						<div class="d-flex justify-content-end mt-4"> 
									<ul class="nav mr-sm-3" style="font-size: 14px;">
										...
										<li class="nav-item">
											<a class="nav-link disabled" style="color: grey">Lowongan Baru</a>
										</li>
									</ul>
								</div>
        					</div>
...
<!--konten-->
		            ...
		            <p style="color: #002147;">
		                ...
		                <br>Kualifikasi : 
		                <ul style="color: #002147;">
		                	<li>S1 Bidang Komputer</li>
		                	<li>Menguasai Java</li>
		                	<li>MySQL posterSQL</li>
		                </ul>
		            </p>
		            <button type="button" href="#" class="btn btn-warning btn-sm"><a href="<?php echo base_url()?>index.php/welcome/detlow">Detail</a></button>
		            <br>
		            <br>
		            ...
		            <button type="button" href="#" class="btn btn-warning btn-sm"><a href="<?php echo base_url()?>index.php/welcome/detlow2"> Detail</a></button>
		            <br>
		            <br>
		            <p class="card-text"><small class="text-muted">20 Desember 2020</small>
            		</p>
				...
				<div class="card border-warning mt-4" style="width: 100;">
        			<div class="card-body  ">
						...
						<p  class="text-warning">
		            		<a href="<?php echo base_url()?>index.php/welcome/kategori"  class="text-dark">Informatika</a>
		        		</p>
		        		<p> 
		            		<a>Kuliner</a>
		        		</p>
